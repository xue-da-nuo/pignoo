...
/**
 * 更新数据：PignooList中的数据可以1:1理解为数据库中的数据，只操作PignooList就能达到操作数据库的效果
 */
@SpringBootTest
public class Demo03_Update {
    ...
    public void add() {
        ...
        newPig.setAge(2);// newPig是PignooList中取出的小猪，这一步等同于更新数据库，此时age=2
    ...
    public void updateByEntity() {
        ...
        var pigList2 = pignoo.getList(Pig.class);
